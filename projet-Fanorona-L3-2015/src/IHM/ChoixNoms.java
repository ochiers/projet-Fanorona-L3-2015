...
public class ChoixNoms extends JPanel {
	...
	class ItemAction_name2 implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			Fenetre.setPanelAccueil(new ImagePanel(fenetre.frame, new ImageIcon("." + File.separator + "Ressources" + File.separator + "images" + File.separator + "image1.jpg").getImage(), ImageObserver.WIDTH, ImageObserver.HEIGHT));
	...
	/*
	 * private static void createAndShow() { int pw = 699; int ph = 549;
	 * 
	 * //fenetre JFrame frame = new JFrame("Choix noms joueurs");
	 * frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE); //ajout case texte
	 * JPanel tmpPanel = new ChoixNoms(); frame.setContentPane(tmpPanel);
	 * frame.setSize(new Dimension(pw, ph)); frame.setVisible(true); }
	 */
